...
<body>
    <div class="ask-for-product">
        {dynamic} {include file='flash_messages.tpl'} {/dynamic} {if true == $mail_send} {literal}
        <script>
            ...
            <fieldset>
                ...
                <div class="edition-form-field">
                    <label for="question_name">
                        <em class="color">*</em> {translate key='Your name'}:
                    </label>
                ...
                <div class="edition-form-field">
                    <label for="question_mail">
                        <em class="color">*</em> {translate key='Your e-mail address'}:
                    </label>
                ...
                <div class="edition-form-field">
                    <label for="question_text">
                        <em class="color">*</em> {translate key='Question'}:
                    </label>
