            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="name f-row">
                        ...
                        <div class="f-grid-8">
                            <input id="search1" class="{if $data_error.search}error{/if}" type="text" name="search" value="{$data.search|escape}" placeholder="" size="30"> {if $data_error.search}
                            <ul class="error">
                    ...
                    <div class="manufacturer f-row">
                        ...
                        <div class="f-grid-8">
                            <select name="producer" id="search3">
                                ...
                                <option {if $producer->manufacturer->producer_id == $data.producer}selected="selected" {/if }value="{$producer->manufacturer->producer_id|escape}">{$producer->manufacturer->name|escape}
                                </option>
                                {/foreach}
                            </select>
                        </div>
                    ...
                    <div class="category f-row">
                        ...
                        <div class="f-grid-8">
                            <select name="category" id="search4">
                                ...
                                <option {if $category->category->category_id == $data.category}selected="selected" {/if }value="{$category->category->category_id|escape}"> {$category->translation->name|escape}
                                </option>
                                {/foreach}
                            </select>
                        </div>
                ...
                {if $view}
                <input type="hidden" name="view" value="{$view|escape}"> {/if}
            </fieldset>
        </form>
    </div>
</div>