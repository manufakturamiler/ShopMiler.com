...
<body{if $body_id} id="{$body_id|escape}"{/if}{if $body_class} class="{$body_class|escape}"{/if}>
                    ...
                    <div class="col-md-5">
                        <div class="product-meta k-product-meta">
                            <div class="bottomborder row">
                                <h1 class="text-left text-2em" itemprop="name">{$product->translation->name|escape}</h1>
                                ...
                                <div class="basket k-basket" itemprop="offers" itemscope itemtype="{$schema}://schema.org/Offer">
                                    ...
                                    <div class="price-netto">
                                        ...
                                        <em {if $skin_settings->global->pricemode == '1'}class="no-color"{/if}>{currency value=$product->defaultStock->getSpecialOfferPrice(true) ceil=2}</em>
                                        {else}
                                        <em {if $skin_settings->global->pricemode == '1'}class="no-color"{/if}>{currency value=$product->defaultStock->getPrice(true) ceil=2}</em>
                                        {/if}
                                    </div>
                                    {/if}
    ...
    <script type="text/javascript">
        try {literal}{{/literal} Shop.values.OptionsConfiguration = "{$options_configuration|escape}"; Shop.values.OptionsDefault = "{$options_default|escape}"; Shop.values.OptionCurrentStock = "{$stock_id|escape}"; Shop.values.optionCurrentVirt = "default"; Shop.values.OptionImgWidth = "{$skin_settings->img->big|escape}"; Shop.values.OptionImgHeight = "0"; {literal}}{/literal} catch(e) {literal}{ }{/literal}
                        ...
                        <div class="availability">
                            ...
                            <div class="productdetails-more-details">
                                ...
                                <div class="productdetails-more">
                                    ...
                                    {/if}
                                </div> <!-- productdetails-more-details -->
                                {/if}
