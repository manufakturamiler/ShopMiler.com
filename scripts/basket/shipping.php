                        ...
                        <form method="post" action="{route key='basketStep3'}">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="shipping-container">
                                    <h5>{translate key="Shipping method"}:</h5> {foreach from=$shippings item=shipping name=list}
                                ...
                                {/if} {if count($payments)}
                                <div class="payment-container">
                                    <h5>{translate key="Payment method"}:</h5> {foreach from=$payments item=payment name=list}
