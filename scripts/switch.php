...
<script type="text/javascript">
    ...
    Shop.basket.shopVisitorId = '{$user->user->userinfo->user_id|escape|base64_encode}'; {
        /if} {
            if $body_class | escape == 'shop_basket_done'
        }
        Shop.basket.orderDone = true; {
            /if}
