            ...
            <fieldset>
                ...
                <div class="producergroup">
                    ...
                    <select name="producer" id="selectproducer">
                        ...
                        <option {if $producer->manufacturer->producer_id == $productfilter_producer}selected="selected" {/if }value="{$producer->manufacturer->producer_id|escape}">{$producer->manufacturer->name|escape}
                        </option>
                        {/foreach}
                    </select>
                </div>
