<div class="box" id="box_currencies">
    ...
    <div class="innerbox">
        ...
        <h5 class="boxintro">{$boxNs->$box_id->text}</h5>{/if} {if $boxNs->$box_id->format == 1}
        ...
        <select class="singleselect gotourl" id="box_currencies_select">
            ...
            <option{if $cur==$ boxNs->$box_id->currency} selected="selected"{/if } value="?currency={$cur|escape}">{$desc|escape}</option>
                {/foreach}
        </select>
